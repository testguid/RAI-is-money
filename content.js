const regex = /(?:(?:USD\s|(?:(?<![a-z])US\s?)?\$(?:\s?USD?)?|US\sDollars?)\s?((?:(?:\d{1,3}){1})(?:(?:\,\d{3}|\d)*)(?:\.\d+)?)(?:\s?(k|mm?|b|t)(?![a-z]))?(?:\s?(?:USD?))?)|(?:((?:(?:\d{1,3}){1})(?:(?:\,\d{3}|\d)*)(?:\.\d+)?)(?:\s?(k|mm?|b|t)(?![a-z]))?(?:\s?(\$(?:(?![a-z])(?:\s?US))|(?:US\s)?Dollars?|\sUSD?\$?(?![a-z]))))/i
const globalRegex = /(?:(?:USD\s|(?:(?<![a-z])US\s?)?\$(?:\s?USD?)?|US\sDollars?)\s?((?:(?:\d{1,3}){1})(?:(?:\,\d{3}|\d)*)(?:\.\d+)?)(?:\s?(k|mm?|b|t)(?![a-z]))?(?:\s?(?:USD?))?)|(?:((?:(?:\d{1,3}){1})(?:(?:\,\d{3}|\d)*)(?:\.\d+)?)(?:\s?(k|mm?|b|t)(?![a-z]))?(?:\s?(\$(?:(?![a-z])(?:\s?US))|(?:US\s)?Dollars?|\sUSD?\$?(?![a-z]))))/ig
